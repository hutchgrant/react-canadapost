...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   ```bash
   # clone your fork
   git clone https://github.com/<your-username>/react-canadapost.git
   # change directory to the repository folder
   cd react-canadapost
   # set the official react-canadapost repo to a remote branch called "upstream"
   git remote add upstream https://github.com/hutchgrant/react-canadapost.git
   ```
